(function ($) {
	...
	jQuery(document).ready(function () {
		...
		// Opens side menu when sandwich icon clicked
		...
		// Close side menu
		$(".menu-close i.fas, .offcanves-menu-overlay, .menu-item-inner li a").on('click', function () {
			$(".off-canvas-menu").removeClass("active");
			$(".offcanves-menu-overlay").removeClass("active");
		});
		$(".smoth-scroll i.fas.fa-envelope").on('click', function() {
			$(".off-canvas-menu").removeClass("active");
			$(".offcanves-menu-overlay").removeClass("active");
		});
